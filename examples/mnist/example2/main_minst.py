...
if __name__ == "__main__":
    ...
    for i in range(70000):
        # Progress bar
        if i % 100 == 0:
            print("\rProgress in train dataset: " + str(i) + "/70000", end="")
    ...
    print("Accuracy in train dataset: ", train_num_correct / 60000, file=f_acc)
    print("Accuracy in test dataset: ", test_num_correct / 10000, file=f_acc)
